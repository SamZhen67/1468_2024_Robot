...
public class COTSFalconSwerveConstants {
    ...
    public static COTSFalconSwerveConstants SDSMK4i(double driveGearRatio){
        ...
        double angleKP = 0.3; // orginally 7.2 but is later overwritten in Constants.java
        double angleKI = 0.0;
        double angleKD = 0.0;

        InvertedValue driveMotorInvert = InvertedValue.Clockwise_Positive; // changed to clockwise on 12/28/23 - SZ
    ...
    public class driveGearRatios{
        ...
        /** SDS MK4i - 6.12 : 1 */
        public static final double SDSMK4i_L3 = (6.122448979591837 / 1.0); // Changed to be more precise - SZ
    }
}
